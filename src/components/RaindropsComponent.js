...
import styles from "../styles/RaindropsComponent.module.css";
  ...
  return (
    <div id="unique-raindrops" className={styles.raindropsContainer}>
      <div className={styles.headerText}>
        <h1>Our Amazing Application</h1>
        <p>
        Welcome to our platform, where innovation meets simplicity. Explore our features and experience the difference! Our application helps you discover the relationship between foods and diseases, providing valuable insights into how specific foods can benefit your health. Start your journey towards better health today
        </p>
      </div>
